...
public class MyResources {
	...
	MyResources(FileSpec file, String packageName, Resources res,
		...
		//Log.d("xxx", "70 - constructor - MyResources");
	...
	/**
	 * Back Independent Resources
	 * <p>
	 * Resources will not operate when processing dependencies,
	 * all dependencies of the content will not appear in the Resources。
	 * 
	 * @return
	 */
	...
	/**
	 * Back Independent AssetManager
	 * <p>
	 * When AssetManager operation does not handle dependencies, all dependencies of the content will not appear in the AssetManager。
	 * 
	 * @return
	 */
	 ...
	 * <p>
	 * It does not handle dependencies, make sure id corresponding layout in the current package of
	 * 
	 * @param name
	 * @return
	...
	public View inflate(Context context, int id, ViewGroup parent,
		...
		//Log.d("xxx", "80 - inflate     - MyResources");
	...
	/**
	 * Loading from the package where the current class MyResource
	 * 
	 * @param clazz
	 * @return
